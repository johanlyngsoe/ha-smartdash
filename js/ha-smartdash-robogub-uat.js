(function(){
  ...
  function update(){
    ...
    const pause=ensureActionButton(actions,"pause-resume","Pause","pause"),stop=consoleEl.querySelector('[data-robogub-action="cancel"]'),dock=consoleEl.querySelector('[data-robogub-action="dock"]'),garden=consoleEl.querySelector('[data-robogub-action="garden4"]'),slope=consoleEl.querySelector('[data-robogub-action="slope4"]');
    if(pause){
